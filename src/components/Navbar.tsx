...
export default function Navbar() {
  ...
  return (
    <nav className="bg-white shadow-sm sticky top-0 z-50 font-montserrat">
      ...
      <div
        className={`md:hidden fixed inset-0 bg-white z-40 transition-all duration-300 ease-in-out ${isMenuOpen ? 'opacity-100 visible translate-y-0' : 'opacity-0 invisible -translate-y-full'
          }`}
        style={{ top: '5rem' }}
      >
