...
export default function PlatformFeatures() {
	return (
		<section className="relative bg-brand-light py-8 md:py-10 lg:min-h-[calc(100vh-5rem)] font-montserrat flex items-center">
			<div className="max-w-7xl mx-auto px-4 w-full">
				...
				<div className="text-center mb-6 md:mb-12 lg:mb-16">
					...
					<p className="text-sm md:text-base lg:text-lg text-brand-gray max-w-2xl mx-auto">
						Everything you need to buy and sell agricultural products
						internationally
					</p>
				</div>
